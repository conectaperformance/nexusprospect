...
const CnpjLeadSearch: React.FC = () => {
    ...
    const [leads, setLeads] = useState<CnpjLead[]>([]);
    ...
    const toggleAll = (termLeads: CnpjLead[]) => {
                ...
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-6">
                    <div>
                        <h2 className="text-xl font-black text-slate-800 flex items-center gap-2.5">
                            ...
                            Extrator de Leads — Base CNPJ
                        </h2>
                        <p className="text-slate-500 mt-1 text-xs">
                            Acesse a Base de CNPJ, faça sua busca por empresas e ative a extensão para enviar os leads para cá.
                        </p>
                    </div>
                ...
                {leads.length > 0 ? (
                    ...
                    <div className="text-center py-16 text-slate-400 bg-slate-50 border border-slate-100 rounded-2xl border-dashed">
                        ...
                        <p className="text-xs mt-1.5 max-w-sm mx-auto text-slate-400">
                            Configure seu Webhook na extensão, acesse a base CNPJ no seu navegador e inicie a extração. Os leads surgirão aqui sozinhos.
                        </p>
                    </div>
                )}
            </div>
